...
function FiberNode(
  ...
  // tag
  // 标识 fiber 类型的标签，类型是 WorkTag，表示对应组件的类型
  this.tag = tag;

  this.key = key;
  this.elementType = null; // 元素类型
  this.type = null; // function 或者 class
  this.stateNode = null; // 真实的dom节点，真实的dom节点，真实的dom节点，！！！！！！！！！！！！！！！
...
const createFiber = function(
  ...
  return new FiberNode(tag, pendingProps, key, mode); // 3 null null 0b000000
};
...
// createFiberFromElement 从React元素创建一个fiber对象
