...
export const NoFlags = /*                      */ 0b00000000000000000000000; // 没有标签
export const PerformedWork = /*                */ 0b00000000000000000000001;

// You can change the rest (and add more).
export const Placement = /*                    */ 0b00000000000000000000010; // 插入
export const Update = /*                       */ 0b00000000000000000000100; // 更新
export const PlacementAndUpdate = /*           */ Placement | Update; // ------ 插入和更新
export const Deletion = /*                     */ 0b00000000000000000001000; // 删除
...
export const DidCapture = /*                   */ 0b00000000000000010000000; // useRef 钩子函数
export const Ref = /*                          */ 0b00000000000000100000000;
export const Snapshot = /*                     */ 0b00000000000001000000000;
export const Passive = /*                      */ 0b00000000000010000000000; // useEffect 钩子函数
